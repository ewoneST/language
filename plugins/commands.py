...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton('⚡ SUPPORT_GROUP ⚡', url=f"https://t.me/st_search_group"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ SUPPORT_GROUP ⚡', url='https://t.me/st_search_group'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/st_movie_upadate')
            ],[
        ...
        m=await message.reply_sticker("CAACAgIAAxkBAAEJmcNkpWRZPfAgNnhti8GXcx7pcSfpSwACcQgAAoSUQUlvaAkaprvOcy8E")
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await message.reply_chat_action(enums.ChatAction.TYPING)
        m=await message.reply_sticker("CAACAgIAAxkBAAEJmjBkpYc6xcIl0Nyu5jk2428wAAFg5sIAAlQAA0G1Vgxqt_jHCI0B-i8E")
        await asyncio.sleep(1)
        await m.delete()
        await message.reply_photo(
            photo=random.choice(PICS),
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('ST√UPDATE', url='https://t.me/st_movie_upadate') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
